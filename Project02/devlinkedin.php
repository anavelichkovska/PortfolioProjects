...
<div class="container-fluid">
    <div class="row">
        <div class="col-md-7 WLframe1 content">
            <div class="row">
                <div class="col-md-10 ">
                    <a type="button" class="btn btn-lg btnGrey font-weight-bold" href="development.php">CV</a>
                    <a type="button" class="btn btn-lg btnGrey font-weight-bold" href="devlinkedin.php">LINKEDIN</a>

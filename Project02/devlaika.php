...
<div class="container-fluid">
    <div class="row">
        <div class="col-md-7 WLframe1 content">
            <div class="row">
                <div class="col-md-10 ">
                    <a type="button" class=" col-md-2 btn btn-lg btnGrey font-weight-bold" href="development.php">CV</a>
                    <a type="button" class=" col-md-2 btn btn-lg btnGrey font-weight-bold" href="devlinkedin.php">LINKEDIN</a>
                    <a type="button" class=" col-md-2 btn btn-lg btnGrey font-weight-bold" href="devlaika.php">WEARELAIKA.COM</a>
                </div>
                <div class="col-md-2 ">
